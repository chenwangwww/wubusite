<template>
  <section class="mt-9 md:ml-16 md:mr-8 mx-4 px-16 bg-white">
    ...
    <div class="flex flex-col items-center gap-[1.0625rem] w-full">
      ...
      <p class="text-black font-lato text-xl font-bold text-center w-full">Submission successful. 
      </p>
      <p class="text-black font-lato text-base text-center w-full">The arrival time depends on the bank. Once the funds are credited, the balance will be updated automatically, and we will notify you through the system.</p>
    </div>
    <div class="flex gap-[2.5rem] w-full my-4 pb-9">
      <div @click="gotofinish" class="flex-1 bg-[#FF7545] rounded-[2.5rem] h-[2.75rem] md:h-[3.5rem] flex items-center justify-center cursor-pointer" >
