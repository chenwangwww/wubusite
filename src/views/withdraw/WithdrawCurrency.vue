<template>
  <section class="mt-9 md:ml-16 md:mr-8 mx-4 md:px-16 px-3 bg-white">
    ...
    <div>
      <SelectInput :options="accountOptions" selectId="receivingAccount-selector" label="Select the receiving account"
    ...
    <div>
      ...
      <UnitInput inputId="amount-amount" label="withdraw amount" placeholder="Enter withdraw amount" v-model="amount"
        v-model:unitValue="selectedCurrency" :available-units="['USD', 'AED']" />
    </div>
    <div class="my-3">
    ...
    <div class="w-full flex justify-center my-3">
      <div @click="gotosubmit" class="w-1/2 bg-black rounded-[2.5rem] h-[2.75rem] flex items-center justify-center cursor-pointer">
